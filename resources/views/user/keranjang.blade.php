    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            ...
            <div class="card p-4">
                ...
                <div class="row">
                    <div class="col-lg-8 mr-auto"></div>
                    <div class="col-lg-2"><a href="{{url('/order')}}" class="btn btn-success"> <i class="fa fa-info"></i> Potong Saldo </a></div>

                    <div class="col-lg-2"><a href="{{url('/order-transfer')}}" class="btn btn-info"> <i class="fa fa-info"></i> Transfer </a></div>
                </div>
