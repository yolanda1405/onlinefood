...
<body id="page-top">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="container">
            <nav class="navbar navbar-expand-lg navbar-light mb-5 shadow-sm" id="mainNav" style="background-color: #ffa366">
                <div class="container">
                    <a class="navbar-brand text-white" href="{{url('/home')}}"><span class="font-weight-bold"> <i style="color: black; font-size: 30px;" class="fas fa-utensils"> ONLINE</i> Food</span></a>
